...
package pe.joedayz.joefact.datasource;
...
public class NumeroALetra {
	...
	// Para llamar numero a letras se realiza lo sigueinte :

	/*
	 * Numero_a_Letra NumLetra = new Numero_a_Letra(); String numero =
	 * "20004.70"; System.out.println( numero + " literal = " +
